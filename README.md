...
However, the parameters are strongly interdependent, with only a limited region producing viable graphs, so Monte Carlo <a href="//bacionejs.github.io/codegolfed/research/montecarlo.html" target="_blank">simulations</a> were run to find values for grid-size, graph-sparsity and path-size. The results revealed a <a href="//bacionejs.github.io/codegolfed/research/chart.html" target="_blank">narrow viable region</a>, and increasing difficulty in some parameters had the paradoxical effect of reducing difficulty [^1], and making the wrong adjustments to some parameters adversely affected path <a href="//bacionejs.github.io/codegolfed/research/analyzer.html" target="_blank">uniqueness</a>. From the range of combinations found, a set was chosen based on established visual and cognitive research.
